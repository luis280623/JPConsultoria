                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" id="a">
                                    @error('nombre')
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" class="form-control @error('num_documento') is-invalid @enderror" aria-describedby="emailHelp" name="num_documento">
                                    @error('num_documento')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            </div>
